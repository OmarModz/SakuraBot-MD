...
*Tipo :* antiprivado 
*Descripción :* Des/Activa el *AntiPrivado* para el Bot

*Tipo :* autoread 
*Descripción :* Des/Activa el *AutoRead* para el Bot

*Tipo :* ia 
*Descripción :* Des/Activa la *Inteligencia Artificial* para el Usuario

*Tipo :* tiktok 
*Descripción :* Des/Activa la *Descarga Automática De TikTok* para el Usuario 

*Tipo :* youtube 
*Descripción :* Des/Activa la *Descarga Automática De YouTube* para el Usuario
