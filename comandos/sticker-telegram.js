...
if (!args[0]) throw `*• Ingresα una url de stickers Telegram*\n\n*Ejemolo:*\n*${usedPrefix + command}* https://t.me/addstickers/Porcientoreal`
if (!args[0].match(/(https:\/\/t.me\/addstickers\/)/gi)) throw `*La url es incorrecta*`
...
await conn.sendFile(m.chat, stiker, null, { asSticker: true }, false, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: true, title: botname, body: `h`, mediaType: 2, sourceUrl: linkgc, thumbnail: miniurl}}}, { quoted: m })  
await delay(5000)
    }
throw `*Listooooo!!*`
}
